...
class FlightService {
  ...
  private var flights = List(
      Flight(1, airports(0), airports(1), LocalDateTime.of(2021, 8, 1, 9, 0), LocalDateTime.of(2021, 8, 1, 12, 0), planes(0), "Scheduled"),
      Flight(2, airports(1), airports(0), LocalDateTime.of(2021, 8, 2, 9, 0), LocalDateTime.of(2021, 8, 2, 12, 0), planes(1), "Scheduled"),
      Flight(3, airports(2), airports(3), LocalDateTime.of(2021, 8, 3, 9, 0), LocalDateTime.of(2021, 8, 3, 12, 0), planes(2), "Scheduled"),
      Flight(4, airports(3), airports(2), LocalDateTime.of(2021, 8, 4, 9, 0), LocalDateTime.of(2021, 8, 4, 12, 0), planes(0), "Scheduled"),
      Flight(5, airports(4), airports(5), LocalDateTime.of(2021, 8, 5, 9, 0), LocalDateTime.of(2021, 8, 5, 12, 0), planes(1), "Scheduled"),
      Flight(6, airports(5), airports(4), LocalDateTime.of(2021, 8, 6, 9, 0), LocalDateTime.of(2021, 8, 6, 12, 0), planes(2), "Scheduled")
    )
